      ...
      <div className="mb-32 space-y-6">
        ...
        <div>
          <ol className="list-decimal space-y-4 px-6">
            <li>
              Конфіденційність користувачів веб-сайту Covenantly має велике
              значення для нас, і ми докладаємо всіх зусиль для забезпечення її
              захисту. Дані правила пояснюють, як ми використовуємо вашу
        ...
        <div className="space-y-4">
          ...
          <ol className="space-y-4 px-6">
            <li>
              Token вашого облікового запису на Covenantly, який допомагає вам
